...
import { ratingSchemeDelegationsRouter, ratingSchemesRouter } from "./rating-schemes";
import { supportFormsRouter } from "./support-forms";
import { supportFormGoalsRouter } from "./support-form-goals";
import { performanceObservationsRouter } from "./performance-observations";
...
apiRouter.use("/rating-schemes", ratingSchemesRouter);
apiRouter.use("/rating-scheme-delegations", ratingSchemeDelegationsRouter);
apiRouter.use("/support-forms", supportFormGoalsRouter);
apiRouter.use("/support-forms", performanceObservationsRouter);
